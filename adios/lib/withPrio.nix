...
let
  ...
  # We need to pad each key with zeros, so when the next function calls
  ...
  # precompute them, and do a lookup. This gives us a complexity of O(n + log(n))
  # for creating the attrset after sorting.
  #
